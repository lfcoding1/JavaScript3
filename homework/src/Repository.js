...
function renderContainer(data){
  ...
  Util.createAndAppend('h1', root, { text: "Hack Your Future Repositories", class: 'title' });
  Util.createAndAppend('h3', root, { text: "Select a repository:  ", class: 'subtitle'});
  const selectList = Util.createAndAppend('select', root, {id: "mySelect" });
  ...
  const contributorsCard = Util.createAndAppend('div', container, {class: 'card'});
